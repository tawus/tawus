package com.googlecode.tawus.extensions.internal.table;
...
public class TableColumnEncoder implements ValueEncoder<TableColumn>
{
   ...
   {
      return String.format("%s/%d/%d/%s-%d", column.getProperty(), column.getRowspan(), column.getColspan(),
            column.getCssClass(), column.getColspanMultiple());
   }
