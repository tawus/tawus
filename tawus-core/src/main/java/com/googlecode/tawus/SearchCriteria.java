...
/**
 * Search criteria used by {@link com.googlecode.tawus.services.EntityDAO} for searching 
 * @param <E>
 */
public class SearchCriteria<E> {
   ...
   /**
    * Constructor
    * The results will be sorted in increasing order. You can change it
    * @param object search object
    * @param firstResult index of first result to be fetched
    */
   ...
   /**
    * Constructor
    * Since the object is not specified, a search object will be created
    * using default constructor
    * @param type search object type
    * @param firstResult index of first result to be fetched
    * @param maxResults maximum results to be fetched
    */
   ...
   /**
    * Constructor 
    * Search Criteria with no sorting
    * @param type search object type
    */
    ...
    * @param maxResults maxResults to show
    */
   ...
   /**
    * Set condition to be used for searching.
    * If null, then the condition will be generated
   ...
   /**
    * Set search type
    * @param searchType searchType to set
    */
