...
/**
 * EasyCrudEvents A set of events used by components in this module
 */
public class TawusEvents
{
   /**
    * Show details This event is triggered when a id link is clicked in the
    * {@link com.googlecode.tawus.components.EntityDisplay} It can be captured
    * using onShowDetails method
    */
   public static final String SHOW_DETAILS = "showDetails";

   /**
    * This event is triggered after
    * {@link com.googlecode.tawus.components.EntityEditForm} cancel button is
    * clicked.
    */
   ...
   /**
    * This event is trigged before the entity is to be deleted in
    * {@link com.googlecode.tawus.components.EntityEditForm}
    */
   public static final String BEGIN_DELETE = "beginDelete";

   /**
    * This event is triggered after the entity is to be deleted in
    * {@link com.googlecode.tawus.components.EntityEditForm}
    */
   public static final String AFTER_DELETE = "afterDelete";

   /**
    * This event is triggered after form has been submitted by any submit button
    ...
    * {@link com.googlecode.tawus.components.EntitySearchForm} has been
    * submitted
    * 
    */
